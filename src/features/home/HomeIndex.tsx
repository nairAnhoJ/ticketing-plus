    ...
    return (
        <>
            <div className="w-screen h-dvh flex flex-col bg-[#212121]">
                <div className="w-full h-16 py-2.25 px-2.5 text-white flex justify-center items-end">
                    <div className="w-full h-full flex items-center">
                        ...
                        <div className="h-full flex flex-col items-start justify-center ml-1.5 relative">
                            ...
                            {
                                showProfileMenu && 
                                <div className="absolute flex flex-col top-6.5 -left-1 rounded p-1 bg-[#454545]">
                ...
                <div className="w-full h-15 flex gap-x-2 pb-2 px-2.5 mb-2">
                ...
                <div className="flex-1 h-[calc(100%-144px)] w-full bg-neutral-100 rounded-t-xl py-3 text-neutral-600">
                    {/* Search */}
                    ...
                    {/* List */}
                    <div className="w-full h-[calc(100%-40px)] overflow-x-hidden overflow-y-auto mt-3 border-neutral-400">
                        <h1 className="text-xs font-bold text-[#808080] px-3 pb-1">TICKETS</h1>
                        <Link to="/tickets/id" className="w-full border-y border-neutral-400 p-2 flex flex-col">
