            ...
            <div className="w-auto h-auto bg-white text-neutral-600 rounded-xl">
                ...
                <div className="w-120 px-6">
                    ...
                    <div className="flex items-center justify-center gap-x-6 mt-3">
                        <button onClick={()=>setData({...data, rating: 1})}><img src={`/icons/${(data.rating == 1 ? 'LikeC.png' : 'LikeG.png')}`} className="h-16 w-auto" /></button>
                ...
                <div className="pt-3 pb-6 flex items-center justify-center gap-x-3">
                    <button disabled={data.rating === 10} onClick={handleSubmit} className="w-26 h-10 bg-blue-500 hover:bg-blue-600 text-white rounded-full text-sm font-medium shadow-lg shadow-neutral-800/30 disabled:pointer-events-none disabled:opacity-70">Submit</button>
                </div>
            </div>
        </div>
    )
